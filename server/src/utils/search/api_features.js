import { getFilter, getHSNCode, getLocation, getPriceRange, getSectors, getSort } from "./search_functions.js";
...
export const searchFiltering = (queryParams) => {
    ...
    const { page, size, sort, filter, rangePrice, location, sourcingFilter, sourcingLocation, formsFilter, hsnCode, sectors } = queryParams;
