...
export const baseUrl = "https://backend-rail-subbase-production.up.railway.app/api/v1";
...
export const baseUrl_IMG = "https://backend-rail-subbase-production.up.railway.app";
// process.env.REACT_APP_NODE_ENV == "production"
// ?
