...
function ImporterRepDetails() {
  ...
  function handleMultiMediaValidation(e, keyWordDoc) {
    ...
    const maxCount = keyWordDoc === "image" ? 1 : 3;

    if (count == 1 && keyWordDoc === "image") {
      setErrorMsg((prevErrors) => ({
        ...prevErrors,
        [keyWordDoc]: `Max length ${maxCount}`,
      }));
      return;
    }

    if (count >= 3 && keyWordDoc === "legalDocs") {
      setErrorMsg((prevErrors) => ({
        ...prevErrors,
        [keyWordDoc]: `Max length ${maxCount}`,
      }));
                  ...
                  <div className="row gap-row-2">
                    ...
                    <div className="col-12">
                      <div className="form-group gap">
                        <label className="form-title">Profile picture </label>
                        <label
                          ...
                          onDrop={(e) => {
                            ...
                            if (files && files.length > 0) {
                              handleMultiMediaValidation(files?.[0], "image");
                            }
                        ...
                        <small className="text-danger">{errorMsg?.image}</small>
