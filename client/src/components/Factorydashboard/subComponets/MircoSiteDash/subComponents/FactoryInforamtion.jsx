...
export default function FactoryInforamtion(props) {
  let { handleShow ,factoryProfile,factoryInfoValidation,show,errorMsg,isLoading,handleClose} = props;
  return (
    <>
                ...
                <div className="w-100 ">
                  <form>
                    <div className="row  row-gap">
                      ...
                      <div className="col-6">
                        <div className="form-group">
                          <label class="form-title">Number of employees</label>
                      ...
                      <div className="col-6">
                          <div className="form-group">
                            <label class="form-title">Facatory Phone Number</label>
                            ...
                            <FormVlaidtionError
                            formValidation={factoryInfoValidation} vlaidationName ="factoryPhone"/>
