...
import { getOneQuote, updateQoute } from "Services/quotations";
...
export default function EditQuote() {
  ...
  let {formValidation}=useFormValidation(apiDetails,submitForm,qualityConditionsArr,paymentTypeArr,ShippingTypeSizeArr,packingConditionsArr);
