...
export default function OfferInfo(props) {
  ...
  />
          ...
          <ReadOnly
    title="sku"
    value={requestedData?.sku}
  />
           
          </div>

          <div className="col-6">
<ReadOnly title="hsnCode" value={requestedData?.productHSNCode} />
...
/>
  ...
  <div className="col-6">
    <ReadOnly
      ...
      value={`${requestedData?.preferredCountries?.join(", ") ||
        "All"}  `}
    />
  </div>
