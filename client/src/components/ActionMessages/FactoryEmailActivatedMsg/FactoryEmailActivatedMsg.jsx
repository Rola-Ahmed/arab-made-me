...
function FactoryEmailActivatedMsg() {
  const [searchParams] = useSearchParams();
  const activationToken = searchParams.get("action");

  document.title = "Factory Emial Activation";
  ...
  async function submitForm() {
    ...
    try {
      let config = {
        method: "get",
        url: `${baseUrl}/factories/confirmEmail/${activationToken}`,
      };
  ...
  async function ReSendToken(e) {
    ...
    try {
      let config = {
        method: "get",
        url: `${baseUrl}/factories/resendConfirmationMail/${userId}`,
      };
                ...
                <div className="frame-container-1 p-5">
                  <div className="cont-frame-1 ">
                    ...
                    <p className="text-sub m-auto">
                      Factory Email has been activated
                    </p>
                  </div>
                </div>
              </div>
...
export default FactoryEmailActivatedMsg;
